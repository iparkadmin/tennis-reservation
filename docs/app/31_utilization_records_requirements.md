...
| 項目 | 種別 | 説明 |
|------|------|------|
| 利用有無 | 分類 | 予約した枠を実際に利用したか |
| マナー状況 | 分類 | 利用時・利用後のマナー（違反なしをデフォルト表示） |
| その他 | 自由記述 | 上記以外の記録したい事由 |
...
| utilization_status | TEXT | 利用有無（used / no_show / unrecorded） |
| manners_status | TEXT | マナー状況（no_violation=違反なし・デフォルト、その他種別） |
| other_notes | TEXT | その他事由（任意） |
